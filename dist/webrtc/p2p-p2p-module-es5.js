...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["p2p-p2p-module"], {
  /***/
  ...
  /***/
  function node_modulesPeerjsDistSyncRecursive(module, exports) {
  ...
  /***/
  function node_modulesPeerjsDistPeerjsMinJs(module, exports, __webpack_require__) {
    var require;
    ...
    parcelRequire = function (e, r, t, n) {
      ...
      function f(t, n) {
        if (!r[t]) {
          if (!e[t]) {
            ...
            if (!n && i) return i(t, !0);
            if (o) return o(t, !0);
            if (true && "string" == typeof t) return __webpack_require__("./node_modules/peerjs/dist sync recursive")(t);
      ...
      if (t.length) {
        ...
        true ? module.exports = l : undefined;
      }
    ...
    }, {}, ["iTK6"], null); //# sourceMappingURL=/peerjs.min.js.map
  ...
  /***/
  "./src/app/p2p/p2p-routing.module.ts":
  /*!*******************************************!*\
    !*** ./src/app/p2p/p2p-routing.module.ts ***!
    \*******************************************/

  /*! exports provided: P2pRoutingModule */

  /***/
  function srcAppP2pP2pRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "P2pRoutingModule", function () {
      return P2pRoutingModule;
    });
    /* harmony import */
    ...
    var _p2p_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./p2p.component */
    "./src/app/p2p/p2p.component.ts");

    var routes = [{
      path: '',
      component: _p2p_component__WEBPACK_IMPORTED_MODULE_2__["P2pComponent"]
    }];

    var P2pRoutingModule = function P2pRoutingModule() {
      _classCallCheck(this, P2pRoutingModule);
    };

    P2pRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: P2pRoutingModule
    });
    P2pRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function P2pRoutingModule_Factory(t) {
        return new (t || P2pRoutingModule)();
      },
      imports: [[_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](P2pRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](P2pRoutingModule, [{
  ...
  /***/
  function srcAppP2pP2pComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "P2pComponent", function () {
      return P2pComponent;
    });
    /* harmony import */
    ...
    function P2pComponent_li_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("input", function P2pComponent_li_8_Template_input_input_2_listener($event) {
          ...
          return ctx_r2.writeToConnection(connection_r1.label, $event.target.value);
        });
      ...
      if (rf & 2) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate2"](" ", connection_r1.peer, " \xA0 Online: ", connection_r1.open, " ");

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](1);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("value", ctx_r0.state[connection_r1.label] || "");
      }
    }
    ...
    var P2pComponent = /*#__PURE__*/function () {
      function P2pComponent(route, //
      ref) {
        _classCallCheck(this, P2pComponent);

        this.route = route;
        this.ref = ref;
        this.id = guid();
        this.peer = new peerjs__WEBPACK_IMPORTED_MODULE_2___default.a(this.id, {
          debug: 3
        });
        this.state = {};
      }

      _createClass(P2pComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;

          this.peer.on('open', function () {
            _this.route.queryParams.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["filter"])(function (params) {
              ...
              var conn = _this.peer.connect(peerId, {
                serialization: 'json'
              });

              conn.on('open', function () {});
              conn.on('data', function (data) {
                _this.readFromConnection(conn.label, data);
              });
            });
          });
        ...
        key: "writeToConnection",
        value: function writeToConnection(connectionId, content) {
        ...
        key: "readFromConnection",
        value: function readFromConnection(connectionId, content) {
        ...
        key: "connections",
        get: function get() {
          return Object.values(this.peer.connections).reduce(function (result, connections) {
            return [].concat(_toConsumableArray(result), _toConsumableArray(connections));
          }, []);
        }
      }]);
    ...
    P2pComponent.ɵfac = function P2pComponent_Factory(t) {
      return new (t || P2pComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"]));
    };

    P2pComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: P2pComponent,
      selectors: [["app-p2p"]],
      decls: 9,
      vars: 3,
      consts: [[4, "ngFor", "ngForOf"], ["type", "text", 3, "value", "input"]],
      template: function P2pComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1, "p2p works!");
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](8, P2pComponent_li_8_Template, 3, 3, "li", 0);
        ...
        if (rf & 2) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("My ID: ", ctx.peer.id, "");

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate1"]("Peer ID: ", ctx.peerId, "");
      ...
      styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3AycC9wMnAuY29tcG9uZW50LnNjc3MifQ== */"]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](P2pComponent, [{
  ...
  /***/
  "./src/app/p2p/p2p.module.ts":
  /*!***********************************!*\
    !*** ./src/app/p2p/p2p.module.ts ***!
    \***********************************/

  /*! exports provided: P2pModule */

  /***/
  function srcAppP2pP2pModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "P2pModule", function () {
      return P2pModule;
    });
    /* harmony import */
    ...
    var _p2p_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./p2p-routing.module */
    "./src/app/p2p/p2p-routing.module.ts");
    /* harmony import */


    var _p2p_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./p2p.component */
    "./src/app/p2p/p2p.component.ts");

    var P2pModule = function P2pModule() {
      _classCallCheck(this, P2pModule);
    };

    P2pModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: P2pModule
    });
    P2pModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      factory: function P2pModule_Factory(t) {
        return new (t || P2pModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _p2p_routing_module__WEBPACK_IMPORTED_MODULE_2__["P2pRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](P2pModule, {
        declarations: [_p2p_component__WEBPACK_IMPORTED_MODULE_3__["P2pComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _p2p_routing_module__WEBPACK_IMPORTED_MODULE_2__["P2pRoutingModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](P2pModule, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
        args: [{
          declarations: [_p2p_component__WEBPACK_IMPORTED_MODULE_3__["P2pComponent"]],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _p2p_routing_module__WEBPACK_IMPORTED_MODULE_2__["P2pRoutingModule"]]
...
//# sourceMappingURL=p2p-p2p-module-es5.js.map